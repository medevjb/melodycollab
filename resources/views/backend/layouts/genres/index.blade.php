...
@section('content')
                ...
                <div class="breadcrumb-wrapper">
                    <nav>
                        <ol class="base-breadcrumb breadcrumb-three">
                            ...
                            <li class="active"><span><i class="lni lni-angle-double-right"></i></span>Genres</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="follow-up-modal">
        <div class="modal fade" id="GenresModal" tabindex="-1" aria-hidden="true">
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"></script>
    <script>
        ...
        $("#VreateUpdateModal").on('submit', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('create.update.genres') }}",
                headers: {
        ...
        function statusChange(id) {
            let url = '{{ route('genres.status', ':id') }}';
            $.ajax({
                type: "GET",
                url: url.replace(':id', id),
                success: function(resp) {
        ...
        function deleteItem(id) {
            let url = '{{ route('genres.destroy', ':id') }}';
