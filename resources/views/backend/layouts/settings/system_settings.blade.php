                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" placeholder="Enter Title" id="ctitle"
                                        class="form-control @error('ctitle') is-invalid @enderror" name="contact_title"
                                        value="{{ $setting->contact_title ?? '' }}" />
                                    @error('ctitle')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" placeholder="Enter phone no." id="phone"
                                        class="form-control @error('phone') is-invalid @enderror" name="contact_phone"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="input-style-1">
                                    ...
                                    <textarea placeholder="Enter contact_address" id="contact_address"
                                        class="form-control @error('contact_address') is-invalid @enderror" name="contact_address"
                                        rows="5">{{ $setting->contact_address ?? '' }}</textarea>
   ...
   <script>
       $(function() {
           const tinymceOptions = {
               selector: '#description, #contact_address',
               menubar: false,
               statusbar: false,
               toolbar_sticky: true,
