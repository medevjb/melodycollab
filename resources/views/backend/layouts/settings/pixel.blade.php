                ...
                <div class="breadcrumb-wrapper">
                    <nav>
                        <ol class="base-breadcrumb breadcrumb-three">
                            ...
                            <li class="active"><span><i class="lni lni-angle-double-right"></i></span>Pixel Settings</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-style mb-4">
                    <form method="POST" action="{{ route('pixel.store') }}">
                        ...
                        <div class="input-style-1">
                            <label for="pixel">Pixel Script:</label>
                            <textarea id="pixel" name="pixel" rows="5" cols="50"
                                class="form-control @error('pixel') is-invalid @enderror" placeholder="<script> ...... </script>">
                                {{ old('pixel',$setting->pixel??'') }}
                            </textarea>
                            @error('pixel')
