...
@section('title', 'Create Premium User')
                ...
                <div class="breadcrumb-wrapper">
                    <nav>
                        <ol class="base-breadcrumb breadcrumb-three">
                            ...
                            <li class="active"><span><i class="lni lni-angle-double-right"></i></span>Email</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-style mb-4">
                    <form method="POST" action="{{ route('membership.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" placeholder="Enter Producer Name" id="producer_name"
                                        class="form-control @error('producer_name') is-invalid @enderror" name="producer_name"
                                        value="{{ old('producer_name') }}" aria-label="producer_name">
                                    @error('producer_name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="input-style-1">
                                    ...
                                    <input type="password" placeholder="Enter Confirm Password" id="password_confirmation"
                                        class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation"
                                        value="{{ old('password_confirmation') }}" aria-label="password_confirmation">
                        ...
                        <div class="row">
                            <div class="col-2">
                                <div class="input-style-1">
                                    <label for="plan_period_start">Plan Period Start:</label>
                                    <input type="date" placeholder="Enter plan_period_start" id="plan_period_start"
                                        class="form-control @error('plan_period_start') is-invalid @enderror" name="plan_period_start"
                                        value="{{ old('plan_period_start') }}" aria-label="plan_period_start">
                                    @error('plan_period_start')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                            ...
                            <div class="col-2">
                                <div class="input-style-1">
                                    <label for="plan_period_end">Plan Period End:</label>
                                    <input type="date" placeholder="Enter plan_period_end" id="plan_period_end"
                                        class="form-control @error('plan_period_end') is-invalid @enderror" name="plan_period_end"
                                        value="{{ old('plan_period_end') }}" aria-label="plan_period_end">
                                    @error('plan_period_end')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
