                    ...
                    <form action="{{ route('notification.send') }}" method="POST">
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" placeholder="Enter Title" id="subject"
                                ...
                                value="{{ old('subject', '') }}" aria-label="Subject">
                            @error('subject')
                        ...
                        <div class="input-style-1">
                            ...
                            <textarea placeholder="Type here..." id="content" name="content"
                                class="form-control @error('content') is-invalid @enderror" aria-label="Email Content">{{ old('content', '') }}</textarea>
                            @error('content')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-sm btn-success" aria-label="Update Email">Send Mail</button>
                        </div>
                    </form>
                </div>
            </div>
