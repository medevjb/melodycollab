        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-style mb-4">
                    <form method="POST" action="{{ route('newsletter.sends') }}">
                        @csrf
                        <input type="hidden" name="email_id" value="{{ $email->id }}">
                        <div class="input-style-1">
                            <label for="subject">Subject:</label>
                            <input type="text" placeholder="Enter Title" id="subject"
                                class="form-control @error('subject') is-invalid @enderror" name="subject"
                                value="{{ old('subject', $email->subject) }}" aria-label="Subject">
                            @error('subject')
                        ...
                        <div class="input-style-1">
                            ...
                            <textarea placeholder="Type here..." id="content" name="content"
                                class="form-control @error('content') is-invalid @enderror" aria-label="Email Content">{{ old('content', $email->content) }}</textarea>
                            @error('content')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-sm btn-primary" aria-label="Update Email">Send Mail</button>
                        </div>
                    </form>
                </div>
            </div>
