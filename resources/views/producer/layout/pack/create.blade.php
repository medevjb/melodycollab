...
@section('content')
    ...
    <section class="app--content">
        ...
        <section class="add--new--pack--area" data-aos="zoom-in" data-aos-duration="1600">
            <h2 class="title--lg text-center">Add New Pack</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 input--space">
                        <div class="input--group input--large pack--price">
                            ...
                            <input type="text" placeholder="00.00" name="price" />
                        </div>
                    ...
                    <div class="col-lg-6 mt_35">
                        ...
                        <div class="pack--feature">
                            ...
                            <div class="features">
                                <textarea name="description" id="description" class="form-control bg-transparent outline-none border-0 text-light"
                                    cols="30" rows="10" placeholder="Example: This pack includes 300 High Quality Samples"></textarea>
        ...
        <div class="default--audio--player">
            <div class="details">
                ...
                <div>
                    <h3 class="title">Cxrker_Someone_Gm_168BP</h3>
            ...
            <div class="controls">
                ...
                <div class="volume--control--wrap">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" id="mute" class="d-none" width="24" height="24"
                        viewBox="0 0 24 24" fill="none">
                        <path
                ...
                <!-- audio  -->
                <audio id="default--audio" src="./assets/audio/2.mp3"></audio>
            </div>
            <!-- hide--audio  -->
