                ...
                <div class="breadcrumb-wrapper">
                    <nav>
                        <ol class="base-breadcrumb breadcrumb-three">
                            ...
                            <li class="active"><span><i class="lni lni-angle-double-right"></i></span>Instrument</li>
                        </ol>
                    </nav>
                </div>
            </div>
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"></script>
    <script>
        $(document).ready(function() {
            ...
            function sendOrderToServer() {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "{{ route('instrument.rendaring') }}",
                    data: {
                        order: order,
                        _token: token
                    },
        ...
        $("#CreateUpdateModal").on('submit', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('create.update.instrument') }}",
                headers: {
        ...
        function ShowUpdateModal(id) {
            let url = '{{ route('instrument.get', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function statusChange(id) {
            let url = '{{ route('instrument.status', ':id') }}';
            $.ajax({
                type: "GET",
                url: url.replace(':id', id),
                success: function(resp) {
        ...
        function deleteItem(id) {
            let url = '{{ route('instrument.destroy', ':id') }}';
