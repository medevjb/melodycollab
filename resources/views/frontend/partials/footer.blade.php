<footer data-aos="fade-in" data-aos-duration="1200">
    <div class="container">
        <div class="footer">
            ...
            <div class="footer--col">
                <div class="footer--box logo">
                    ...
                    <p>
                        Connecting music producers worldwide. Share your melodies for free, collaborate on beats, and
                        earn together. Sell your sample packs on our marketplace and turn your creativity into income.
                        Join this community and collaborate with industry-leading producers.
                    </p>
                </div>
                <div class="custom--footer">
                    <div class="footer--box links">
                        ...
                        <ul>
                            <li>
                                <a href="{{ route('producer.browse') }}">Melodies</a>
                            </li>
                            <li>
                                <a href="{{ route('producer.browse') }}">Genres</a>
                            </li>
                            <li>
                            ...
                            {{-- <li>
                                <a href="{{ route('how.to.use') }}">How it works</a>
                            </li> --}}
                        </ul>
                    </div>
                    <!-- footer box  -->
                    <div class="footer--box links double">
                        <ul>

                            @forelse ($dynamicPages as $page)
                                <li>
                                    <a
                                        href="{{ route('dynamic.page', ['slug' => $page['page_slug']]) }}">{{ $page['page_title'] }}</a>
                                </li>
                            @empty
                            @endforelse
            ...
            <!-- footer box  -->
            <div class="footer--box social test">
        ...
        <div class="footer--bottom">{{ $setting->copyright ?? '' }}</div>
    </div>
</footer>
